...
filename <- file.path("img", paste(Sys.time(), "wordcloud2 trending hashtag", hashtag, "FR.png", sep = "-"))
...
```{r}
# Post tweet
post_tweet(status = paste0("Here's one of the trending hashtags among MEPs tweeting in French this week: #", hashtag, ". Find out more at https://www.europeandatajournalism.eu/Tools-for-journalists/Quote-Finder/"), media = filename, token = twitter_token)
```