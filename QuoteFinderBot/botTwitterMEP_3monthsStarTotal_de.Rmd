---
title: "QuoteFinder Twitter bot - Star in Germany"
...
filename <- file.path("img", paste(Sys.time(), "star_wordcloud2_3months_DE.png", sep = "-"))
...
```{r}
# Post tweet
post_tweet(status = paste0("What did MEPs tweet in German in the last three months? Here's a summary in a star. Find out more: https://www.europeandatajournalism.eu/Tools-for-journalists/Quote-Finder/"), media = filename, token = twitter_token)
```
