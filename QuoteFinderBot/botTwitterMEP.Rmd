...
```{r sentiment wordcloud first hashtag}
...
# Post tweet
post_tweet(status = paste0("What did MEPs have to say good or bad about", paste0(" #", topHashtag$en[1]), "? Here's a sentiment analysis wordcloud based on tweets posted in the last month. Explore the tweets https://apps.europeandatajournalism.eu/QuoteFinderApp/"), media = filename, token = twitter_token)
```
