...
```{r}
# Post tweet
post_tweet(status = paste0("Cosa hanno twittato gli europarlamentari in italiano negli ultimi tre mesi? Leggi ed esplora i tweet anche in altre lingue: https://www.europeandatajournalism.eu/Tools-for-journalists/Quote-Finder/"), media = filename, token = twitter_token)
```
